...
class UsernameInvestigator:
    ...
    PLATFORMS = {
        ...
        'discord': {
            ...
            'method': 'content',
            'exists_patterns': [r'discord-user-profile', r'user-name', r'avatar'],
            'not_found_patterns': [r'Not found', r'404', r'does not exist'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'snapchat': {
            'url': 'https://www.snapchat.com/add/{}',
            'method': 'content',
            'exists_patterns': [r'snapcode', r'profile-name', r'display-name'],
            'not_found_patterns': [r'Not found', r'404', r'does not exist'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'facebook': {
            ...
            'method': 'content',
            'exists_patterns': [r'profile_id', r'entity_id', r'fb://profile', r'userContent'],
            'not_found_patterns': [r'Page introuvable', r'Page Not Found', r'not found', r'This content'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'mastodon': {
            'url': 'https://mastodon.social/@{}',
            'method': 'content',
            'exists_patterns': [r'account__display-name', r'account__header', r'@{}'],
            'not_found_patterns': [r'Not found', r'404', r'Account suspended'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'threads': {
            'url': 'https://www.threads.net/@{}',
            'method': 'content',
            'exists_patterns': [r'thread-content', r'user-info', r'profile-pic'],
            'not_found_patterns': [r'Not found', r'404', r'does not exist'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'quora': {
            ...
            'method': 'content',
            'exists_patterns': [r'profile-name', r'user-profile', r'Credential'],
            'not_found_patterns': [r'Not found', r'404', r'Page Not Found'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'tumblr': {
            'url': 'https://{}.tumblr.com',
            'method': 'content',
            'exists_patterns': [r'blog-title', r'avatar', r'posts'],
            'not_found_patterns': [r'Not found', r'404', r'Unknown blog'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'telegram': {
            'url': 'https://t.me/{}',
            'method': 'content',
            'exists_patterns': [r'tgme_page_extra', r'tgme_username', r'tgme_action_button'],
            'not_found_patterns': [r'If you have Telegram, you can contact', r'right away.'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'kick': {
            'url': 'https://kick.com/{}',
            'method': 'content',
            'exists_patterns': [r'channel-name', r'profile-pic', r'follow-btn'],
            'not_found_patterns': [r'Not found', r'404', r'Page not found'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'rumble': {
            ...
            'method': 'content',
            'exists_patterns': [r'channel-name', r'video-list', r'subscribers'],
            'not_found_patterns': [r'Not found', r'404', r'Page not found'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'bitbucket': {
            ...
            'method': 'content',
            'exists_patterns': [r'repository-list', r'profile-info', r'avatar'],
            'not_found_patterns': [r'Not found', r'404', r'repository does not exist'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'npm': {
            'url': 'https://www.npmjs.com/~{}',
            'method': 'content',
            'exists_patterns': [r'package-name', r'profile-pic', r'packages-section'],
            'not_found_patterns': [r'Not found', r'404', r'Profile not found'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'docker': {
            'url': 'https://hub.docker.com/u/{}',
            'method': 'content',
            'exists_patterns': [r'profile-name', r'repository-list', r'user-info'],
            'not_found_patterns': [r'Not found', r'404', r'Profile not found'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'keybase': {
            ...
            'method': 'content',
            'exists_patterns': [r'user-card', r'identity', r'proofs'],
            'not_found_patterns': [r'Not found', r'404', r'does not exist'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'codepen': {
            ...
            'method': 'content',
            'exists_patterns': [r'profile-name', r'pen-list', r'profile-avatar'],
            'not_found_patterns': [r'Not found', r'404', r'Profile not found'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
        'replit': {
            ...
            'method': 'content',
            'exists_patterns': [r'profile-name', r'repls-list', r'profile-avatar'],
            'not_found_patterns': [r'Not found', r'404', r'User not found'],
            'headers': {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'},
        },
    }
